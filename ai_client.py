...
#crear la herramienta de AI para poder usarla
...
if token:
    print("IA: Hola soy tyu agente de IA integrado a la API")
    ...
    while True:
        ...
        prompt = (
            ...
            f"Usa 'consultar_mis_tareas' si es necesario."
        )

        try: 
            #llamar el modelo para que el maneje lash erramientas
            ...
            if "429" in error_str:
                ...
                print ("IA: Error de la version del modelo. Intentando reconectar")
                # TO DO: Generar la logica
            else:
                print("Error de conexion")
